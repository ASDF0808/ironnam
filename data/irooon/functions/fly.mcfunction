...
execute as @a[tag=fly,tag=ironman,scores={ironman=..0,ironpower=1..,flying=..0},nbt={OnGround:0b}] at @s if block ^ ^ ^1 #irooon:likeair run tp @s ^ ^ ^1
execute as @a[tag=fly,tag=ironman,scores={ironman=..0,ironpower=1..,flying=..0},nbt={OnGround:0b}] at @s if block ^ ^ ^1 #irooon:likeair run tp @s ^ ^ ^1
...
execute as @a[tag=fly] at @s run effect give @s levitation 1 255 true
