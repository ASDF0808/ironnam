...
execute as @a[tag=ironman,nbt={SelectedItemSlot:0},scores={ironman=1..,slot=0,iloop=..99}] positioned ^ ^ ^0.5 if block ~ ~ ~ #irooon:likeair run effect give @e[dx=0,tag=!ironman,type=#irooon:undead] instant_health 1 1 true
execute as @a[tag=ironman,nbt={SelectedItemSlot:0},scores={ironman=1..,slot=0,iloop=..99}] positioned ^ ^ ^0.5 if block ~ ~ ~ #irooon:likeair run effect give @e[dx=0,tag=!ironman,type=!#irooon:undead] instant_damage 1 1 true
execute as @a[tag=ironman,nbt={SelectedItemSlot:0},scores={ironman=1..,slot=0,iloop=..99}] positioned ^ ^ ^0.5 positioned ~ ~-1 ~ if block ~ ~ ~ #irooon:likeair run effect give @e[dx=0,tag=!ironman,type=#irooon:undead] instant_health 1 1 true
execute as @a[tag=ironman,nbt={SelectedItemSlot:0},scores={ironman=1..,slot=0,iloop=..99}] positioned ^ ^ ^0.5 positioned ~ ~-1 ~ if block ~ ~ ~ #irooon:likeair run effect give @e[dx=0,tag=!ironman,type=!#irooon:undead] instant_damage 1 1 true
