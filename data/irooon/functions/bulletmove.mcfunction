...
execute as @e[tag=booom,nbt={OnGround:1b}] at @s run summon minecraft:creeper ~ ~ ~ {Fuse:0,ExplosionRadius:10,Invulnerable:1b}
execute as @e[tag=booom,nbt={OnGround:1b}] at @s run kill @s
