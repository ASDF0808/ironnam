execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^ ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^0.2 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^-0.2 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^-0.4 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^0.4 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^-0.6 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^0.6 ^1 ^1 run particle dust 0 1 0.949 0.9 ~ ~ ~ 0 0.5 0 0 50 force
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^0.6 ^2.5 ^1 run summon armor_stand ~ ~ ~ {Tags:[sheild],Invisible:1b,Silent:1b} 
...
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^0.2 ^ ^1 run summon armor_stand ~ ~ ~ {Tags:[sheild],Invisible:1b,Silent:1b} 
execute as @a[scores={ironman=1..,slot=0,ironpower=2..},tag=ironman,nbt={SelectedItemSlot:2}] at @s positioned ^ ^ ^1 run summon armor_stand ~ ~ ~ {Tags:[sheild],Invisible:1b,Silent:1b} 
